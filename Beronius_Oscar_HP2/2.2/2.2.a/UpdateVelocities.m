function velocities = UpdateVelocities(particlePositions, particleBest, swarmBest, particleVelocities, cognitiveComponent, socialComponent, deltaT, vMax)
  ...
  for i = 1:size(particlePositions, 1)
    ...
    for j = 1:size(particlePositions,2)  
      ...
      velocity = velocity + cognitiveComponent*q*((currentBest - currentPosition)/deltaT) + socialComponent*r*((dimensionBest-velocity)/deltaT);
